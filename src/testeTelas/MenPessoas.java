 ...
 * @author Rafael
 */
public class MenPessoas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/testeTelas/barraoff.png"))); // NOI18N
...
>>>>>>> 16c2e9b (implementing field checker)
        ...
        jMenuItem4.setText("Cadastro de Cargos");
        ...
        jMenuItem2.setText("Cadastro de Categorias");
...
>>>>>>> 16c2e9b (implementing field checker)
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        CadPessoaa tela = new CadPessoaa();
        tela.pack();
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        CadCategorias tela = new CadCategorias();
        tela.pack();
        tela.setLocationRelativeTo(null);
        tela.setVisible(true);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(MenPessoas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenPessoas().setVisible(true);
            }
        });
    }
